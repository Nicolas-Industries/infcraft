...
public class EntityTNTPrimed extends Entity {
    ...
    public EntityTNTPrimed(final ServerWorld serverWorld) {
        super(serverWorld);
        this.fuse = 0;
    ...
    public EntityTNTPrimed(final ServerWorld fe, final float xCoord, final float yCoord, final float zCoord) {
        this(fe);
