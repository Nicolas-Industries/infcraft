...
public class EntitySplashFX extends EntityRainFX {
    ...
    public EntitySplashFX(final ServerWorld fe, final double double2, final double double3, final double double4, final double double5, final double double6, final double double7) {
