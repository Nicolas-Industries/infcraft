...
public class EntitySkeleton extends EntityMonster {
    ...
    public EntitySkeleton(final ServerWorld serverWorld) {
        super(serverWorld);
    ...
    protected void attackEntity(final Entity entity, final float xCoord) {
        if (xCoord < 10.0f) {
            ...
            // Convert radians to degrees and adjust for facing direction
            this.rotationYaw = (float) (toDegrees(atan2(zCoord, xCoord2))) - 90.0f;
