...
public class EntityLiving extends Entity {
    ...
    public EntityLiving(final World serverWorld) {
        super(serverWorld);
    ...
    public void onLivingUpdate() {
        ++this.entityAge;
        // TODO: implement multiplayer tracking for mobs
...
//        }
    ...
    public boolean getCanSpawnHere(final double nya1, final double nya2, final double nya3) {
        ...
        if (this.world instanceof ServerWorld) {
            return ((ServerWorld) this.world).checkIfAABBIsClear1(this.boundingBox) && this.world.getCollidingBoundingBoxes(this, this.boundingBox).size() == 0 && !this.world.getIsAnyLiquid(this.boundingBox);
        } else {
            return true;
        }
    }
