...
import net.opencraft.core.world.chunk.ChunkPosition;
...
public class RailBlock extends Block {
    ...
    public boolean canPlaceBlockAt(final ServerWorld serverWorld, final int xCoord, final int yCoord, final int zCoord) {
        return serverWorld.isBlockNormalCube(xCoord, yCoord - 1, zCoord);
    }

    @Override
    public void onBlockAdded(final ServerWorld serverWorld, final int xCoord, final int yCoord, final int zCoord) {
        serverWorld.setBlockMetadataWithNotify(xCoord, yCoord, zCoord, 15);
        this.refreshTrackShape(serverWorld, xCoord, yCoord, zCoord);
    }
    ...
    public void onNeighborBlockChange(final ServerWorld serverWorld, final int xCoord, final int yCoord, final int zCoord, final int nya4) {
        ...
        if (blockMetadata == 2 && !serverWorld.isBlockNormalCube(xCoord + 1, yCoord, zCoord)) {
            b = true;
        }
        if (blockMetadata == 3 && !serverWorld.isBlockNormalCube(xCoord - 1, yCoord, zCoord)) {
            b = true;
        }
        if (blockMetadata == 4 && !serverWorld.isBlockNormalCube(xCoord, yCoord, zCoord - 1)) {
            b = true;
        }
        if (blockMetadata == 5 && !serverWorld.isBlockNormalCube(xCoord, yCoord, zCoord + 1)) {
            b = true;
        }
        if (b) {
    ...
    private void refreshTrackShape(final ServerWorld serverWorld, final int xCoord, final int yCoord, final int zCoord) {
        new RailLogic(this, serverWorld, xCoord, yCoord, zCoord).refreshTrackShape();
    }
    ...
    public static class RailLogic {
        ...
        public RailLogic(final RailBlock bn, final ServerWorld fe, final int integer3, final int integer4, final int integer5) {
            this.rail = bn;
            this.serverWorld = fe;
        ...
        private RailLogic getMinecartTrackLogic(final ChunkPosition ia) {
            if (this.serverWorld.getBlockId(ia.x, ia.y, ia.z) == this.rail.blockID) {
                return new RailLogic(this.rail, this.serverWorld, ia.x, ia.y, ia.z);
            }
            if (this.serverWorld.getBlockId(ia.x, ia.y + 1, ia.z) == this.rail.blockID) {
                return new RailLogic(this.rail, this.serverWorld, ia.x, ia.y + 1, ia.z);
            }
            if (this.serverWorld.getBlockId(ia.x, ia.y - 1, ia.z) == this.rail.blockID) {
                return new RailLogic(this.rail, this.serverWorld, ia.x, ia.y - 1, ia.z);
            }
        ...
        private void func_788_d(final RailLogic hk) {
            ...
            if (metadataValue == 0) {
                if (this.serverWorld.getBlockId(this.trackX, this.trackY + 1, this.trackZ - 1) == this.rail.blockID) {
                    metadataValue = 4;
                }
                if (this.serverWorld.getBlockId(this.trackX, this.trackY + 1, this.trackZ + 1) == this.rail.blockID) {
                    metadataValue = 5;
            ...
            if (metadataValue == 1) {
                if (this.serverWorld.getBlockId(this.trackX + 1, this.trackY + 1, this.trackZ) == this.rail.blockID) {
                    metadataValue = 2;
                }
                if (this.serverWorld.getBlockId(this.trackX - 1, this.trackY + 1, this.trackZ) == this.rail.blockID) {
                    metadataValue = 3;
            ...
            this.serverWorld.setBlockMetadataWithNotify(this.trackX, this.trackY, this.trackZ, metadataValue);
        }
        ...
        public void refreshTrackShape() {
            ...
            this.setConnections();
            this.serverWorld.setBlockMetadataWithNotify(this.trackX, this.trackY, this.trackZ, n);
            for (int i = 0; i < this.connectedTracks.size(); ++i) {
                final RailLogic minecartTrackLogic = this.getMinecartTrackLogic((ChunkPosition) this.connectedTracks.get(i));
                if (minecartTrackLogic != null) {
                    minecartTrackLogic.func_785_b();
