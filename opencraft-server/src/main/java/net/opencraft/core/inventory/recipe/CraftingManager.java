...
import net.opencraft.core.inventory.recipe.RecipesSwords;
import net.opencraft.core.inventory.recipe.RecipesTools;
import net.opencraft.core.inventory.recipe.RecipesUtilities;
