...
import net.infcraft.core.entity.EntityRainFX;
...
public class EntityRenderer {
    ...
    public EntityRenderer(final InfCraft aw) {
    ...
    private Vec3 orientCamera(final float float1) {
        final EntityPlayerLocal thePlayer = this.mc.player;
    ...
    private void h(final float multiplier) {
        final EntityPlayerLocal player = this.mc.player;
