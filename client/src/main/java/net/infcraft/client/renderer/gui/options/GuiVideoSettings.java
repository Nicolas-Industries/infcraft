...
package net.infcraft.client.renderer.gui.options;

import net.infcraft.client.config.GameSettings;
import net.infcraft.client.renderer.gui.GuiButton;
import net.infcraft.client.renderer.gui.GuiScreen;
import net.infcraft.client.renderer.gui.GuiSlider;
import net.infcraft.client.renderer.gui.GuiSmallButton;
