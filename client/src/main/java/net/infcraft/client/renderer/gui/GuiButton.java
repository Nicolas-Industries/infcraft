...
public class GuiButton extends GuiElement {
    ...
    public GuiButton(final int buttonId, final int xPosition, final int yPosition, final String displayString, final int width, final int height) {
        this(buttonId, xPosition, yPosition, width, height, displayString);
    }

    protected GuiButton(final int buttonId, final int xPosition, final int yPosition, final int width, final int height, final String displayString) {
        this.width = 200;
        this.height = 20;
        this.enabled = true;
        this.enabled2 = true;
    ...
    public void drawButton(final InfCraft aw, final int integer2, final int integer3) {
        if (!this.enabled2) {
            return;
        }
