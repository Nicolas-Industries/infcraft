...
import static net.infcraft.client.renderer.entity.EntityRenderer.gluPerspective;
...
public class ItemRenderer {
    ...
    public ItemRenderer(final InfCraft aw) {
        this.b = null;
        this.c = 0.0f;
        this.d = 0.0f;
        this.e = 0;
    ...
    public void renderItemInFirstPerson(final float float1) {
        ...
        final EntityPlayerLocal thePlayer = this.a.player;
        GL11.glPushMatrix();
        ...
        GL11.glPopMatrix();
        final float lightBrightness = this.a.clientWorld.getLightBrightness(Mth.floor_double(thePlayer.posX), Mth.floor_double(thePlayer.posY), Mth.floor_double(thePlayer.posZ));
    ...
    public void renderOverlays(final float float1) {
        ...
        if (this.a.clientWorld.player.isEntityInsideOpaqueBlock()) {
            ...
            GL11.glBindTexture(3553, this.a.renderer.loadTexture("/assets/terrain.png"));
            final int blockId = this.a.clientWorld.getBlockId(xCoord, floor_double, floor_double2);
