...
import net.infcraft.client.renderer.gui.options.GuiControls;
import net.infcraft.client.renderer.gui.options.GuiMusicAndSounds;
import net.infcraft.client.renderer.gui.options.GuiVideoSettings;
