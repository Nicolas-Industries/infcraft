...
import net.infcraft.client.renderer.entity.models.*;
...
public class RenderManager {
    ...
    public EntityPlayerLocal livingPlayer;
    ...
    public void cacheActiveRenderInfo(ClientWorld fe2, Renderer id2, FontRenderer ej2, EntityPlayerLocal gi2, GameSettings ja2, float f2) {
    ...
    public void func_852_a(ClientWorld fe2) {
        this.clientWorldObj = fe2;
    }
