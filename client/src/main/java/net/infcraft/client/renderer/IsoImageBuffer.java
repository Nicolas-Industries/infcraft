...
public class IsoImageBuffer {
    ...
    public IsoImageBuffer(final ClientWorld fe, final int integer2, final int integer3) {
    ...
    public void setWorldAndChunkPosition(final ClientWorld fe, final int integer2, final int integer3) {
        this.worldObj = fe;
        this.setChunkPosition(integer2, integer3);
    }
}
