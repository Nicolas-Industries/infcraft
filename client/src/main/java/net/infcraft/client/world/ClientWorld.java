...
import net.infcraft.client.world.chunk.ChunkCache;
import net.infcraft.client.world.chunk.ChunkProviderClient;
import net.infcraft.client.world.chunk.storage.ChunkLoader;
...
import net.infcraft.core.world.NextTickListEntry;
...
public class ClientWorld implements World {
    ...
    public void spawnPlayerWithLoadedChunks() {
        try {
            if (this.D != null) {
                ...
                if (InfCraft.oc != null
                        && InfCraft.oc.isMultiplayerWorld()) {
    ...
    public void playSound(Entity entity, String soundName, float volume, float pitch) {
        this.playSoundEffect(entity.posX, entity.posY, entity.posZ, soundName, volume, pitch);
    }
    ...
    @Override
    public void addWorldAccess(net.infcraft.core.world.IWorldAccess worldAccess) {

    }

    @Override
    public void removeWorldAccess(net.infcraft.core.world.IWorldAccess worldAccess) {
            ...
            for (int j = floor_double3; j < floor_double4; ++j) {
                for (int k = floor_double5; k < floor_double6; ++k) {
                    ...
                    if (block != null && block.blockMaterial == material
                            && floor_double4 >= (j + 1 - net.infcraft.core.blocks.LiquidBlock
                                    .getPercentAir(this.getBlockMetadata(i, j, k)))) {
                        b = true;
    ...
    public void updateEntities() {
        ...
        if (InfCraft.oc != null && InfCraft.oc.isMultiplayerWorld()) {
    ...
    // NOOP implementations for server-only methods
    @Override
    public void saveWorldIndirectly(net.infcraft.core.world.IProgressUpdate progressUpdate) {
    ...
    @Override
    public void saveWorld(boolean flag, net.infcraft.core.world.IProgressUpdate progressUpdate) {
