...
import net.infcraft.client.renderer.gui.GuiChest;
import net.infcraft.client.renderer.gui.GuiCrafting;
import net.infcraft.client.renderer.gui.GuiEditSign;
import net.infcraft.client.renderer.gui.GuiFurnace;
import net.infcraft.client.world.chunk.Chunk;
import net.infcraft.client.InfCraft;
import net.infcraft.client.Session;
...
import net.infcraft.core.nbt.NBTBase;
import net.infcraft.core.nbt.NBTTagCompound;
import net.infcraft.core.nbt.NBTTagList;
import net.infcraft.core.entity.EntityPlayer;
import net.infcraft.core.tileentity.TileEntityFurnace;
...
public class EntityPlayerLocal extends EntityPlayer {
    ...
    public EntityPlayerLocal(final InfCraft aw, final ClientWorld fe, final Session gg) {
        super(fe);
        this.mc = aw;
        if (fe != null) {
            if (fe.player != null) {
    ...
    public void onLivingUpdate() {
        ...
        int chunkX = net.infcraft.core.util.Mth.floor_double(posX) >> 4;
        int chunkZ = net.infcraft.core.util.Mth.floor_double(posZ) >> 4;
        if (world != null && world instanceof ClientWorld) {
            Chunk chunk = ((ClientWorld) world).getChunkFromChunkCoords(chunkX,
                    chunkZ);
            ...
            if (this.posX != this.prevPosX || this.posY != this.prevPosY || this.posZ != this.prevPosZ
                ...
                try {
                    this.mc.getClientNetworkManager()
                            .sendPacket(new net.infcraft.shared.network.packets.PacketPlayerPosition(
    ...
    public void onItemPickup(final Entity eq) {
        this.mc.effectRenderer
                .addEffect(new net.infcraft.core.entity.EntityPickupFX(this.mc.clientWorld, eq, this, -0.5f));
    }
