...
public class Main {
	...
	public static final String TITLE = "InfCraft " + VERSION;
	...
	public static void main(String[] args) throws Exception {
		...
		InfCraft oc = new InfCraft((int) (screenSize.width * INITIAL_WINDOW_SIZE_FACTOR), (int) (screenSize.height * INITIAL_WINDOW_SIZE_FACTOR), false);
	...
	public static String version() {
		...
		if(RESOURCES.jarFile != null) {
			try {
				...
				System.out.println("An error occurred in git version fetching: " + e.getMessage());
			}
		} else {
