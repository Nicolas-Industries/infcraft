...
public class SoundPool {
    ...
    public SoundPoolEntry addSound(String soundName, URL resourceURL) {
        ...
        // System.out.println("Added sound: " + sound.soundNameNoExt + " (" +
        // sound.soundName + ") from " + resourceURL + " to the sound pool.");
        this.allSoundPoolEntries.add(sound);
        ++this.numberOfSoundPoolEntries;
        return sound;
    }

    public SoundPoolEntry addSound(String key, String soundName, URL resourceURL) {
        SoundPoolEntry sound = new SoundPoolEntry(soundName, resourceURL);
        ...
        this.nameToSoundPoolEntriesMapping.get(key).add(sound);
        this.allSoundPoolEntries.add(sound);
        ++this.numberOfSoundPoolEntries;
        return sound;
    }
