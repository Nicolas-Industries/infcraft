...
package net.infcraft.core.world.chunk.storage;
...
import net.infcraft.core.world.IChunkLoader;
import net.infcraft.server.world.ServerWorld;
import net.infcraft.core.world.chunk.Chunk;
import net.infcraft.core.world.chunk.NibbleArray;
...
public class ChunkLoader implements IChunkLoader {
    ...
    public Chunk loadChunk(final ServerWorld fe, final int integer2, final int integer3) {
    ...
    public void saveChunk(final ServerWorld fe, final Chunk jw) {
    ...
    public void storeChunkInCompound(final Chunk jw, final ServerWorld fe, final NBTTagCompound ae) {
    ...
    public static Chunk loadChunkIntoWorldFromCompound(final ServerWorld fe, final NBTTagCompound ae) {
    ...
    public void saveExtraChunkData(final ServerWorld fe, final Chunk jw) {
    }
}
