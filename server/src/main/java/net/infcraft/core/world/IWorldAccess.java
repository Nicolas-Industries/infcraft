...
public interface IWorldAccess {
    ...
    void markBlockRangeNeedsUpdate(final int integer1, final int integer2, final int integer3, final int integer4,
            final int integer5, final int integer6);

    void playSound(final String soundName, final double xCoord, final double yCoord, final double zCoord,
            final float volume, final float pitch);

    void spawnParticle(final String particle, final double xCoordBlock, final double yCoordBlock,
    ...
    void onEntityPickup(Entity collector, Entity collected);
}
