...
public final class ItemStack {
    ...
    public boolean useItem(final EntityPlayer gi, final ServerWorld fe, final int integer3, final int integer4, final int integer5, final int integer6) {
    ...
    public ItemStack useItemRightClick(final ServerWorld fe, final EntityPlayer gi) {
