...
import net.infcraft.core.blocks.FurnaceBlock;
...
public class TileEntityFurnace extends TileEntity implements IInventory {
    ...
    public void updateEntity() {
        ...
        if (b != this.furnaceBurnTime > 0) {
            b2 = true;
            FurnaceBlock.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.serverWorldObj, this.xCoord, this.yCoord, this.zCoord);
        }
        if (b2) {
            this.serverWorldObj.func_698_b(this.xCoord, this.yCoord, this.zCoord);
        }
    }
