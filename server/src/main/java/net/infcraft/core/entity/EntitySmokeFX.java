...
public class EntitySmokeFX extends EntityFX {
    ...
    public EntitySmokeFX(final ServerWorld fe, final double double2, final double double3, final double double4) {
        this(fe, double2, double3, double4, 1.0f);
    }

    public EntitySmokeFX(final ServerWorld fe, final double double2, final double double3, final double double4, final float float5) {
