...
public class EntityFallingSand extends Entity {
    ...
    public EntityFallingSand(final ServerWorld serverWorld) {
        super(serverWorld);
        this.fallTime = 0;
    }

    public EntityFallingSand(final ServerWorld serverWorld, final float xCoord, final float yCoord, final float zCoord, final int blockid) {
        super(serverWorld);
        this.fallTime = 0;
