...
public class EntityPlayer extends EntityLiving {
    ...
    public EntityPlayer(final World serverWorld) {
        super(serverWorld);
    ...
    public void displayGUIEditSign(TileEntitySign jn) {
    }
    ...
    public void onItemPickup(final Entity eq) {
        // Broadcast pickup packet
        if (this.world instanceof ServerWorld) {
            ServerWorld serverWorld = (ServerWorld) this.world;
            serverWorld.notifyEntityPickup(this, eq);
        }
    }
