...
public class InventoryPlayer implements IInventory {
    ...
    public void setCurrentItem(final int itemId) {
        final int inventorySlotContainItem = this.getInventorySlotContainItem(itemId);
    ...
    public void clearInventoryChanged() {
