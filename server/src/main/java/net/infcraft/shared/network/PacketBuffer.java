...
public class PacketBuffer {
     ...
     */
    public void writeItemStack(net.infcraft.core.item.ItemStack stack) {
        if (stack == null) {
            writeShort(-1);
        } else {
    ...
    public net.infcraft.core.item.ItemStack readItemStack() {
        short id = readShort();
        if (id < 0) {
            return null;
        }
        ...
        return new net.infcraft.core.item.ItemStack(id, count, damage);
    }
