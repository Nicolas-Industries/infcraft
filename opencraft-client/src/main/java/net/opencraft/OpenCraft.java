...
//            Controllers.create();
	...
	public void startWorld(final String string) {
		...
		// Instead of creating a local world, we'll receive world data from the server
		// For now, we'll still create a world instance as a placeholder
		// In a full implementation, we'd receive the world from the server
