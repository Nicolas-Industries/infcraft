...
public class GuiIngameMenu extends GuiScreen {
    ...
    public void drawScreen(final int integer1, final int integer2, final float float3) {
        ...
        // FIXME: attempts to save world on the client
        // this should be handled by the server instead, fire an event to the integrated server to save the world
//        if (!this.id.clientWorld.quickSaveWorld(this.updateCounter2++) || this.updateCounter1 < 20) {
