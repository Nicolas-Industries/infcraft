...
public class GuiCreateWorld extends GuiScreen {
    ...
    protected String getSaveFileName(final int integer) {
        return (ClientWorld.potentiallySavesFolderLocation(OpenCraft.getGameDir(), new StringBuilder().append("World").append(integer).toString()) != null) ? new StringBuilder().append("World").append(integer).toString() : null;
    }
    ...
    protected void actionPerformed(final GuiButton iq) {
        ...
        if (iq.buttonId == -20) {
            final String[] worldNames = ClientWorld.getSaveNames(OpenCraft.getGameDir());
