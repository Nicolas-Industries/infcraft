...
import net.opencraft.core.entity.EntityPainting;
import net.opencraft.core.enums.EnumArt;
...
public class RenderPainting extends Render<EntityPainting> {
    ...
    private void func_160_a(final EntityPainting cy, final float float2, final float float3) {
        ...
        final float lightBrightness = this.renderManager.clientWorldObj.getLightBrightness(nya1, floor_double, nya2);
