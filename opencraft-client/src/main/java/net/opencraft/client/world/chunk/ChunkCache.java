...
public class ChunkCache implements IBlockAccess {
    ...
    public ChunkCache(final ClientWorld world, final int integer2, final int integer3, final int integer4, final int integer5, final int integer6, final int integer7) {
        this.worldObj = world;
    ...
    public float getLightBrightness(final int nya1, final int nya2, final int nya3) {
        return ClientWorld.lightBrightnessTable[this.getLightValue(nya1, nya2, nya3)];
    }
