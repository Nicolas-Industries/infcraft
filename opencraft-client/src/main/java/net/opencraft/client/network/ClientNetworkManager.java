...
public class ClientNetworkManager implements INetworkManager {
    ...
    private void handleWorldInitPacket(net.opencraft.shared.network.packets.PacketWorldInit packet) {
        ...
        // In a real implementation, this would initialize the client world from the server data
        if (gameInstance != null && gameInstance.clientWorld != null) {
            // Update world properties from server
            ...
            // Note: We can't easily update the world seed and time in the client WorldClient class
            // as those are part of the base world. This would need more architectural changes.
        }
    }
